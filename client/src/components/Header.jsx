    ...
    <div className="flex items-center justify-center max-sm:flex-col-reverse gap-20 gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      ...
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">
          Effortlessly remove backgrounds from images with AI-powered precision.
          <br className="max-md:hidden" />
          Get clean, high-quality cutouts in seconds—no design skills needed!
        </p>
